...
mgtra[(dist == 1 | dist == "Pending" | dist == 2 | dist == 3 | dist == 4 | dist == 5), "Trachoma_mapping_gaps"] = 1

mgtra[(dist == 0 | dist == "NS" | dist == 100), "Trachoma_mapping_gaps"] = 2
...
map_gap_final = merge(mglf, mgtra, by="district_global_task_force_id", all = TRUE)
map_gap_final = map_gap_final[,-(7:9)]
